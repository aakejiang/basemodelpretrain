# -*- coding: utf-8 -*-
"""
Created on Fri Oct 11 17:16:54 2019
...
parser.add_argument('--schedule', type=int, nargs='+', default=[25, 37],
...
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='vggc',
                    choices=model_names,
...
parser.add_argument('--save_dir', default='results-vggzj/', type=str)
...
def main():
    ...
    #model = models.__dict__[args.arch](args.depth, num_classes=10)
