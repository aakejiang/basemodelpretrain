...
parser.add_argument('--schedule', type=int, nargs='+', default=[175, 258],
...
# Architecture
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet_cifar',
                    choices=model_names,
...
parser.add_argument('--save_dir', default='caifar100-resnet56prune/', type=str)
...
def main():
    ...
    #code = [10]*27
    #code = [10]*54
    model = models.__dict__[args.arch].resnet(args.cfg,food=None)
