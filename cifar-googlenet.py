# -*- coding: utf-8 -*-
"""
Created on Sun Sep 22 08:39:55 2019
...
# Optimization options   508 
parser.add_argument('--epochs', default=540, type=int, metavar='N',
...
parser.add_argument('--schedule', type=int, nargs='+', default=[270, 405],
                        help='Decrease learning rate at these epochs.')
parser.add_argument('--gamma', type=float, nargs='+', default=[0.1, 0.1], 
...
parser.add_argument('--arch', '-a', metavar='ARCH', default='googlenet',
                    ...
                    help='model architecture: ' +
                        ' | '.join(model_names) +
                        ' (default: resnet18)')
parser.add_argument('--cfg', type=str, default='googlenet', 
...
parser.add_argument('--save_dir', default='caifar10-googlenet/', type=str)
...
def main():
    ...
    #code = [10]*9
    model = models.__dict__[args.arch](honey=None)
