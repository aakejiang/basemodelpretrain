    ...
    def make_layers(self, cfg, batch_norm=False):
        ...
        for x in cfg:
            if x == 'M':
                ...
                conv2d = nn.Conv2d(in_channels, x, kernel_size=3, padding=1, dilation=1)
                if batch_norm:
        ...
        #conv6 = nn.Linear(67, 1024, kernel_size=3, padding=6, dilation=6)
